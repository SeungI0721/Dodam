// 자유게시판 글 목록을 Firebase Realtime Database에서 조회하는 Activity 파일이다.
...
public class community_f extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_community_f);

        // 게시판 이동 버튼을 연결한다.
        Button btu_cback = findViewById(R.id.btu_cback);
        Button btu_topo = findViewById(R.id.btu_topo);
        Button btu_go = findViewById(R.id.btu_go);
        Button btu_q = findViewById(R.id.btu_q);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren() ) {
                    ...
                    if (post != null) {
                        ...
                        if (post.getCategory() == null || "FREE".equals(post.getCategory())) {
                            arrayList.add(post); // 자유게시판 글만 화면 목록에 추가한다.
                        }
                    }
                }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Log.e("community_f", String.valueOf(databaseError.toException()));
            }
        });
        ...
        // 글쓰기 버튼을 누르면 자유게시판 카테고리로 글쓰기 화면을 연다.
